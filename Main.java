...
import exception.NumberExc;
import exception.StringRuntime;

import static Enum.Names.*;

public class Main {
    public static void main(String[] args) throws NumberExc{
        ...
        try{
            ...
            System.out.println("Exception in thread \"main\" exception.NumberExc: "+e.getMessage());
        }
        ...
        } catch (StringRuntime e){
            throw new StringRuntime(e.getMessage());
        }
